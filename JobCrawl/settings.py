...
DOWNLOADER_MIDDLEWARES = {
    ...
    'JobCrawl.middlewares.RandomUserAgentMiddleware': 1,
    # 'JobCrawl.middlewares.JSPageMiddleware' : 100,
...
ITEM_PIPELINES = {
    # 'JobCrawl.pipelines.JobCrawlPipeline': 3,
    'JobCrawl.pipelines.MysqlTwistedPipline': 1,
    # 'JobCrawl.pipelines.MysqlTwistedPythonPipline':2,
}
